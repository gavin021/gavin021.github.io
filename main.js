...
const translations = {
    'en': {
        ...
        'company-profile-capital': 'JPY 2,000,000',
        ...
        'contact-form-message': 'Message',
        'contact-form-submit': 'Submit',
        'service-food-export-title': 'Japanese Food Export Services (China & Southeast Asia)',
        'service-food-export-intro': 'We provide comprehensive support for exporting and local sales expansion of Japanese products such as wagyu beef, seafood, and processed foods to China and Southeast Asian countries. We offer one-stop services including local regulatory compliance, export customs clearance, cold chain logistics, and matching with buyers and agents.',
        'service-seafood-export-title': 'Japanese Seafood Export Services',
        'service-seafood-export-subtitle': 'Delivering premium ocean treasures to the world\'s tables.',
        'service-seafood-export-detail': 'We carefully select seafood products from all over Japan, including Hokkaido scallops, Sanriku salmon, dried and frozen processed products, and support exports to China and Southeast Asian markets. We comply with local import regulations and quarantine standards, maintaining freshness through cold chain logistics. We can handle a wide range of sales channels from wholesale to high-end supermarkets and restaurants.',
        'service-wagyu-export-title': 'Japanese Wagyu Export Services',
        'service-wagyu-export-subtitle': 'The world\'s most coveted taste, delivered to your country.',
        'service-wagyu-export-detail': 'We select the highest quality wagyu beef from all over Japan, focusing on A5 grade Kuroge Wagyu. We provide comprehensive support for complex quarantine and certificate issuance, temperature management, and transportation arrangements for meat exports. We also leverage our network with local high-end restaurants, hotels, and butcher shops to achieve overseas expansion while maintaining brand value.',
    },
    'zh': {
        'nav-home': '首页',
        'nav-about': '关于我们',
        ...
        'contact-form-message': '咨询内容',
        'contact-form-submit': '提交',
        'service-food-export-title': '日本食品海外拓展・出口服务（中国・东南亚）',
        'service-food-export-intro': '我们为日本产和牛、水产品、加工食品等提供中国及东南亚国家的出口・当地销售拓展一站式支持服务。包括当地法规应对、出口通关、冷链物流、买家・代理商匹配等全方位服务。',
        'service-seafood-export-title': '日本水产出口服务',
        'service-seafood-export-subtitle': '将高品质的海鲜珍品，送到世界的餐桌。',
        'service-seafood-export-detail': '精选北海道扇贝、三陆三文鱼、干货・冷冻加工品等日本各地水产品，支持向中国・东南亚市场出口。应对当地进口法规和检疫标准，通过冷链物流保持新鲜度。从批发到高端超市・餐厅，可应对广泛的销售渠道。',
        'service-wagyu-export-title': '日本和牛出口服务',
        'service-wagyu-export-subtitle': '世界向往的极致美味，送到您的国家。',
        'service-wagyu-export-detail': '以A5级黑毛和牛为中心，从日本全国精选最高级和牛。为肉类出口提供复杂的检疫・证书发放、温度管理、运输安排等一站式支持。同时活用与当地高端餐厅、酒店、肉店的网络，在保持品牌价值的前提下实现海外拓展。',
    },
    'jp': {
        'nav-home': 'ホーム',
        'nav-about': '会社概要',
        ...
        'contact-form-message': 'お問い合わせ内容',
        'contact-form-submit': '送信',
        'service-food-export-title': '日本産食品の海外展開・輸出サービス（中国・東南アジア）',
        'service-food-export-intro': '日本産の和牛、水産物、加工食品などを対象に、中国および東南アジア諸国への輸出・現地販売展開を一括支援するサービスです。現地規制対応、輸出通関、コールドチェーン物流、バイヤー・代理店とのマッチングまでをワンストップで提供します。',
        'service-seafood-export-title': '日本水産輸出サービス',
        'service-seafood-export-subtitle': '高品質な海の幸を、世界の食卓へ。',
        'service-seafood-export-detail': '北海道産ホタテや三陸のサーモン、乾物・冷凍加工品など、日本各地の水産品を厳選し、中国・東南アジア市場に向けて輸出を支援します。現地の輸入規制や検疫基準にも対応し、コールドチェーン物流で新鮮さを保持。業務用卸から高級スーパー・レストランまで、幅広い販路に対応可能です。',
        'service-wagyu-export-title': '日本和牛輸出サービス',
        'service-wagyu-export-subtitle': '世界が憧れる、極上の味をあなたの国へ。',
        'service-wagyu-export-detail': 'A5ランクの黒毛和牛を中心に、日本全国から最高級和牛を選定。食肉輸出における複雑な検疫・証明書発行、温度管理、輸送手配までを一括サポートします。現地の高級レストラン、ホテル、精肉店とのネットワークも活かし、ブランド価値を保った形で海外展開を実現します。',
    }
};
