...
const translations = {
    ...
    'zh': {
        ...
        'service-overseas-commitment': 'ActionFor通过适当的当地法规合规、分销基础设施和促销支持，建立了将日本优质产品安全高效地输送到中国市场的体系。现在正是将日本制造商的"真正价值"带到海外市场的最佳时机。我们承诺与贵公司一起，将优质的日本产品可靠地交付给需要的当地消费者，创造信任和成果。',
        ...
        'contact-email-text': '邮箱：andrealee.actionfor@gmail.com',
        ...
        'privacy-email': '邮箱：andrealee.actionfor@gmail.com',
    ...
    'jp': {
        ...
        'service-overseas-intro': '中国市場においては、都市部を中心に中間層の台頭が著しく、年収３0万元以上の消費者が人口の45％を超えると推計されております。この成長層は、単なる「価格」ではなく「品質」「安全性」「信頼性」を購買判断の最重要項目としています。',
        'service-overseas-features-intro': '特に以下の特徴を持つ日本製品は、中国市場で極めて高い競争力を有しています：',
        'service-overseas-feature-1': '安全性・無添加・高品質といった日本ならではの製造基準',
        'service-overseas-feature-2': '正確な成分表示とトレーサビリティ',
        'service-overseas-feature-3': '"日本製"というブランド自体が信頼の証とみなされる文化背景',
        'service-overseas-feature-4': '清潔感・機能性・細部へのこだわり',
        'service-overseas-commitment': 'ActionForは、こうした日本の誇るべき製品を、適切な現地規制対応・流通整備・販促支援を通じて、中国市場に安心かつ効率的に届ける体制を整えております。今こそ、日本メーカー様の持つ"ほんものの価値"を海外に届ける絶好のタイミングです。私たちは御社とともに、優れた日本製品を必要とする現地消費者の元へ確実に届け、信頼と成果に繋げることをお約束いたします。',
        ...
        'contact-email-text': 'メール：andrealee.actionfor@gmail.com',
        ...
        'privacy-email': 'メール：andrealee.actionfor@gmail.com',
